import random as rd
import rastreador.logica_controle_rt as pf
...
def algoritmo_genetico(planta, func_referencia, pesos, populacao_inicial, sim_time = 20):
    ...
    for geracao in range(MAX_GERACOES):
        fitnesses = [pf.calcula_fitness(pf.calcula_performance(planta, func_referencia, *ind, sim_time=sim_time), pesos, sim_time) for ind in populacao_atual]
